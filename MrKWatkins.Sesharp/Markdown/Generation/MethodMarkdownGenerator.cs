...
public sealed class MethodMarkdownGenerator(MemberLookup memberLookup, string outputDirectory) : MemberMarkdownGenerator<Method, MethodInfo>(memberLookup, outputDirectory)
{
