...
public sealed class MethodMarkdownGenerator(IFileSystem fileSystem, MemberLookup memberLookup, string outputDirectory) : MemberMarkdownGenerator<Method, MethodInfo>(fileSystem, memberLookup, outputDirectory)
{
